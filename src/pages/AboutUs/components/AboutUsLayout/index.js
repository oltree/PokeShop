  ...
  <div className={styles.wrapper}>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.content}>
          <p>
            ...
            for all ages. Pokémon launched in Japan in 1996 and today is one of
            the most popular children’s entertainment properties in the world.
          </p>
          <p>
            Whether you are a player, collector, parent, professor, or fan, we
            strive to offer items featuring a wide range of Pokémon to allow you
            to express yourself.
          </p>
          <p>
            We’re always open. Come say hello and take a look at the wide world
            of Pokémon!
          </p>
        </div>
    ...
    <div className={styles.products}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.content}>
          ...
          <p>
            True to the Pokémon spirit, the Pokémon Center products are made to
            our high standards.
          </p>
        </div>
      </div>
    ...
    <div className={styles.story}>
      ...
      <div className={styles.content__story}>
        <p>
          PokéShop is inspired by the Pokémon video game, where Pokémon Centers
          are important destinations that help Trainers on their journey. In
          that tradition, physical Pokémon Centers were first introduced in
          Japan by The Pokémon Company and continues to thrive in a new online
          form at PokemonCenter.com.
        </p>
        <p>
